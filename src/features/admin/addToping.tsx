...
export default function AddTopings() {
  return (
    <>
    <NavbarSessions/>
      <Flex h={"100vh"} mt={"-24"} justifyContent={"center"} gap={"50"} p={"16"}>
        <Box flex={"1"} h={"80vh"} mt={"24"} >
          <Text fontSize={"36px"} fontWeight={800} className="color-text">Toping</Text>
          <FormControl isRequired  isInvalid className="form-margin">
            <Input placeholder="Toping Name" />
          </FormControl>
          <FormControl isRequired  isInvalid  className="form-margin">
            <Input placeholder="Price" />
          </FormControl>
          <FormControl isRequired  isInvalid  className="form-margin" >
            <Input placeholder="Image Toping" type="file"/>
          </FormControl>
          <Box w={"100%"}  mt={"100px"}>
